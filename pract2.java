...
{
    String title, Bauthor;
    int qty=0,i,ch,ch1;
    double price, mp=0, p=0;
    
    Book[] Booklist = new Book[3];
    Booklist[0]=new Book(1,"Java", "Herbert Schildt", 900, 10 );
    Booklist[1]=new Book(2,"Database", "Jason Price", 4000, 10 );
    Booklist[2]=new Book(3,"Cloud", "Brian Spendolini", 4000, 10 );
    
    Magazine[] m1=new Magazine[2];
  m1[0]=new Magazine(1,"M1",300, 10 );
  m1[1]=new Magazine(2,"M2",400, 10);
